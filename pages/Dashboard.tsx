    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Button variant="ghost" size="sm" asChild>
            <Link to="/library" className="gap-1 items-center flex">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Button variant="ghost" size="sm" asChild>
            <Link to="/schedule" className="gap-1 items-center flex">
              View all <ChevronRight className="h-4 w-4" />
            </Link>
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <Link to="/schedule" className="flex flex-col items-center justify-center border-2 border-dashed border-muted rounded-lg p-6 h-full min-h-[200px] hover:border-primary/50 transition-colors">
