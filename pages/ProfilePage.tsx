          ...
          <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4 flex-1">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      This is how your name will appear to other users in the app.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Brief description about yourself. This will be visible to guests and collaborators.
                </p>
              </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="link" className="h-auto p-0">Reset Password</Button>
                </div>
